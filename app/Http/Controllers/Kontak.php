...
class Kontak extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data->namamasjid = $request->namamasjid;
        $data->nostat = $request->nostat;
        $data->alamatmasjid = $request->alamatmasjid;
        $data->namaamil = $request->namaamil;
        $data->nikamil = $request->nikamil;
